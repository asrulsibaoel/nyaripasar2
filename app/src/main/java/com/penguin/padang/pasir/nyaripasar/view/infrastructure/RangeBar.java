...
package com.penguin.padang.pasir.nyaripasar.view.infrastructure;
...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_BAR_COLOR = Color.parseColor("#8b8a90");

    private static final int DEFAULT_TEXT_COLOR = Color.WHITE;

    private static final int DEFAULT_TICK_COLOR = Color.parseColor("#d8d7dc");

    // Corresponds to material indigo 500.

    // bOLL NO COLOR
    private static final int DEFAULT_PIN_COLOR = Color.parseColor("#8b8a90");
    ...
    // Sadi no color
    private static final int DEFAULT_CONNECTING_LINE_COLOR = Color.parseColor("#8b8a90");
